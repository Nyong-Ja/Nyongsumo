...
(() => {
    ...
    const make = (g, old, x) => `
        <div class="deep-ghost-detail">
            <section class="dayan-section"><div class="dayan-section-head"><span>01</span><div><h3>헌팅 메커니즘</h3><p>사냥 정신력과 이동 속도부터 확인하세요.</p></div></div>
                ${evidenceHtml(g)}
            ...
            <section class="dayan-section"><div class="dayan-section-head"><span>02</span><div><h3>고유 능력 & 세부 메커니즘</h3><p>단순 특징이 아니라 실제 발동 조건을 중심으로 봅니다.</p></div></div>
                ${old || `<p class="dict-text">${x.ability}</p>`}
            </section>
            <section class="dayan-section"><div class="dayan-section-head"><span>03</span><div><h3>강점 & 약점</h3><p>실전에서 위험한 상황과 역으로 이용할 수 있는 요소입니다.</p></div></div>
            ...
            <section class="dayan-section"><div class="dayan-section-head"><span>04</span><div><h3>판별 테스트</h3><p>한 가지 행동만 보고 확정하지 말고 여러 테스트를 교차 확인하세요.</p></div></div>
            ...
            <section class="dayan-section"><div class="dayan-section-head"><span>05</span><div><h3>자주 헷갈리는 부분</h3><p>잘못된 한 줄 요약을 피하세요.</p></div></div>
            ...
            <section class="dayan-tip-box"><span>NYONGSUMO TIP</span><h3>${g.name}은 <strong>조건을 기록하면서</strong> 판별하세요.</h3><p>${g.tip}</p><div><b>정신력</b><strong>${g.huntSanity || g.sanity}</strong><i>→</i><b>속도</b><strong>${g.speed}</strong></div></section>
        </div>`;
