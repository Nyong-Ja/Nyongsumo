...
const GHOST_SIGNATURE_SKILLS = {
    ...
    // 유레이
    "유레이": "열린 문을 완전히 닫고 7.5m 내 정신력 -15%",
    "Yurei": "열린 문을 완전히 닫고 7.5m 내 정신력 -15%",
    ...
    // 마일링 / 밀링
    "마일링": "사냥 발소리·음성 12m / 전자기기 교란 10m",
    "밀링": "사냥 발소리·음성 12m / 전자기기 교란 10m",
    "Myling": "사냥 발소리·음성 12m / 전자기기 교란 10m",

    // 원령 / 온료
    "원령": "불꽃 3회 소화 시 사냥 능력 시도 / 불꽃이 사냥을 우선 차단",
    "온료": "불꽃 3회 소화 시 사냥 능력 시도 / 불꽃이 사냥을 우선 차단",
    "Onryo": "불꽃 3회 소화 시 사냥 능력 시도 / 불꽃이 사냥을 우선 차단",

    // 트윈스
    "트윈스": "하나의 유령·두 상호작용 범위 / 1.5↔1.9m/s",
    "The Twins": "하나의 유령·두 상호작용 범위 / 1.5↔1.9m/s",
    ...
    // 모로이
    "모로이": "정신력에 따라 1.5→2.25m/s & 저주 시 수동 정신력 감소 2배",
    "Moroi": "정신력에 따라 1.5→2.25m/s & 저주 시 수동 정신력 감소 2배",
    ...
    "오밤보": "차분 1.445/10% ↔ 공격적 1.955/65%, 2분 주기 전환",
    "Obambo": "차분 1.445/10% ↔ 공격적 1.955/65%, 2분 주기 전환",
    "아스왕": "은신처 숨으면 살해 불가 & 가속 속도 최고속",
    "Aswang": "은신처 숨으면 살해 불가 & 가속 속도 최고속",
    "코르모스": "질주 30m·보행 15m·웅크림 10m 발소리 탐지 / 1.3배 이동",
    "Kormos": "질주 30m·보행 15m·웅크림 10m 발소리 탐지 / 1.3배 이동"
};
